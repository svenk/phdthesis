...
\clip(3.,2.) rectangle (10,15.);
%\draw (-9.054648077622614,16.09585994040913) node[anchor=north west] {\large ref. level  $\ell +1$:};
%\draw (-8.06493153309748,4.172132009546519) node[anchor=north west] {\large ref. level  $\ell$:};
...
%\draw[color=black] (23,9) node {WENO rec.};
...
%\draw[color=black] (34.5,9) node {WENO-$L_2$ average};
%%%
...
%\draw[color=black] (17.43205182824052,5.821659588914865) node {$\mathcal{P}$};
...
%\draw[color=black] (17.432051828240525,0.4017832567045862) node {$\mathcal{R}$};
%%%
...
%\draw[color=black] (17.66769862455603,12.278381828156675) node {$\mathcal{R}$};
%%%
\draw[color=qqqqff] (5.8,13.8) node {\includegraphics[width=1.5\textwidth]{AMR_finelevel.pdf}};
\draw[color=qqqqff] (5.8,3.8) node {\includegraphics[width=1.5\textwidth]{AMR_finelevel_subgrid.pdf}};
%\draw[color=qqqqff] (28,15.8) node {\includegraphics[width=.35\textwidth]{AMR_finelevel_subgrid}};
%\draw[color=qqqqff] (28,2.8) node {\includegraphics[width=.35\textwidth]{AMR_coarselevel_subgrid}}; 
%\end{scriptsize}
%\draw[color=black] (5.8,20) node {\Large \underline{DG piecewise-polyn.}};
%\draw[color=black] (28,20) node {\Large \underline{WENO piecewise-const.}};
\end{tikzpicture}}